...
public class FaceDetectRoundView extends View {
    ...
    public static final float WIDTH_SPACE_RATIO = 0.46f;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        float y = (canvasHeight / 2) - ((canvasHeight / 2) * HEIGHT_RATIO); //864
	    //float y = (canvasHeight / 2);   //960
        float r = (canvasWidth / 2) - ((canvasWidth / 2) * WIDTH_SPACE_RATIO);  //402
