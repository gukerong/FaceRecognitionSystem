...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "GOFqNgodRz7B5rvlS2QypU93";
    public static String secretKey = "7hGBYaYUCq3pXiRvd6hgInWUgjTojESQ";
    public static String licenseID = "xmrtFace-face-android";
